...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -566820980L;
    ...
    public final com.umc.workbook.domain.QMission mission;

    public final EnumPath<com.umc.workbook.domain.enums.MissionStatus> status = createEnum("status", com.umc.workbook.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.mission = inits.isInitialized("mission") ? new com.umc.workbook.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
